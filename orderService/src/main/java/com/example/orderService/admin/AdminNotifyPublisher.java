...
public class AdminNotifyPublisher {
    ...
    public void sessionOpened(String uuid) {
        publish("SESSION_OPENED", Map.of("uuid", (Object) uuid));
    }

    public void sessionClosed(String uuid) {
        publish("SESSION_CLOSED", Map.of("uuid", (Object) uuid));
    }
    ...
    public void orderReady(String uuid, String orderNo) {
        publish("ORDER_READY", Map.of("uuid", (Object) uuid, "orderNo", orderNo));
    }

    public void orderDelivered(String uuid, String orderNo) {
        publish("ORDER_DELIVERED", Map.of("uuid", (Object) uuid, "orderNo", orderNo));
    }
